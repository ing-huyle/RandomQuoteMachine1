...
export default function App() {
  ...
  const [content, setContent] = useState("Everything exists.");
    ...
    <div id="quote-box">
      ...
      <div className="btn-row">
        <button className="btn" style={{ backgroundColor: color }}>
          <a className="btn-icon" href={`https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp&text=${content}`} target="_blank">
